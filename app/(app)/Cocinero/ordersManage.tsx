...
// Importamos onSnapshot para escuchar cambios en tiempo real
...
export default function ChefOrders() {
  ...
  const statusColors = {
    'ordered': '#E63946', // Rojo para pedidos nuevos
    'cooking': '#F4A261', // Naranja para en cocina
    'done': '#2A9D8F', // Verde para terminados
    'ready for pickup': '#264653', // Azul oscuro para listos
    'Ordenado': '#E63946', // Versiones en español
    'Cocinandose': '#F4A261',
    'Hecho': '#2A9D8F',
    'Listo para llevar a la mesa': '#264653',
  };

  useEffect(() => {
    setIsLoading(true);
    
    // Configuramos un listener en tiempo real para la colección de pedidos
    // Ordenamos por createdAt en orden descendente para mostrar los más recientes primero
    const ordersQuery = query(collection(db, 'orders'), orderBy('createdAt', 'desc'));
    
    // Este listener se activará cada vez que haya un cambio en la colección de pedidos
    ...
    <View style={styles.orderItem}>
      ...
      <View style={styles.statusContainer}>
        ...
        <Picker
          ...
          onValueChange={(itemValue) => updateOrderStatus(item.id, itemValue)}
          style={styles.picker}
        >
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.title}>Chef's Order Dashboard</Text>
